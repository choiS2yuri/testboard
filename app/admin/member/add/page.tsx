...
export default function AdminAdd(){
    ...
    return(
        ...
        <div className="widget w-full overflow-hidden mb-5 p-4">
            <h3 className="text-center font-bold">회원추가</h3>
        </div>
        <div className="widget w-full overflow-hidden mb-5 p-4">
        ...
        <div className="flex justify-end gap-x-5 pb-5">
            ...
            <button onClick={submitEvent} className="bg-orange-500 text-white px-4 py-2 rounded shadow-md hover:bg-orange-600">가입</button>
        </div>
    </>
    )
}