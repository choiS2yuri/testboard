            ...
            <div className="mt-5 md:mt-0 basis-full md:basis-[49.3%]">
                <div className="widget mb-5">
                    <div className="font-bold p-5 py-3 flex justify-between items-center">
                        <h3>신규게시글<span className="text-red-500">{postData &&postData.length}</span>개</h3>
                        <Link href='./admin/member' className="focus:outline-none text-white bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm p-5 py-2.5">게시글전체</Link>
                    </div>
                            ...
                            postData && postData.map((e,i)=>{
                                ...
                                return(
                                    <ul key={i} className="flex justify-between border-b last:border-0 items-center">
                                        <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xs sm:text-sm pb-2">{e.username}</li>
                                        <li className="basis-2/5 text-[#6f809a] font-bold text-center text-xs sm:text-sm pb-2">{e.content}</li>
                                        <li className="basis-1/5 text-[#6f809a] font-bold text-center text-xs sm:text-sm pb-2">{fotmatDate}</li>
                                    </ul>
                                )
                            })
                        }
                ...
                <div className="widget md:mb-5">
                    <div className="font-bold p-5 py-3 flex justify-between items-center">
                        <h3>신규댓글 <span className="text-red-500">{commentData&&commentData.length}</span>개</h3>
                        <Link href='./admin/member' className="focus:outline-none text-white bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm p-5 py-2.5">댓글전체</Link>
                    </div>
                    <div className="w-full">
                        <ul className="flex py-4 text-sm justify-between border-b bg-[#f6f9fc]">
                            <li className="basis-[33%] text-[#6f809a] font-bold text-center text-xs sm:text-sm">닉네임</li>
